						...
						<div class="form-group">
						  ...
						  <select name="tariff_plan_group_title" class="form-control" required>
								<?php foreach($tariff_plans_groups as $tariff_plans_group): ?>
									<option <?php if ($tariff_plan->getTariffPlanGroupTitle() == $tariff_plans_group->getTariffPlanGroupTitle())echo "selected";?>><?=$tariff_plans_group->getTariffPlanGroupTitle()?></option>
								<?php endforeach; ?>
						  </select>
						</div>
						  <div class="form-group">
