					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<span class="top_tariff_plan_amount"> <?=$popular_tariff_plan['amount']?> заказа</span>
								<div class="progress-bar" role="progressbar" aria-valuenow=<?=$popular_tariff_plan['amount']?> aria-valuemin="0" aria-valuemax="10000" style="width: <?=$popular_tariff_plan['amount']*10?>%; background: rgb(<?php echo rand(0, 255);?>, <?php echo rand(0, 255);?>, <?php echo rand(0, 255);?>);">
								</div>
							</div>								
							<?php endforeach; ?>
						</div>
